...
--max-n-jobs 999 --id-job 1_short_horizon_rec_7_from_rec_28_summer_end_mpc_small_K --mem-per-cpu 2500 --root-dir $ROOT_DIR --job-dir-name short_horizon_rec_7_from_rec_28_summer_end_mpc_jobs --time-limits 0 0 15 0 --multiprice-flags no-multiprice $SMALL_PEN_CTRL_ACTIONS $SOLUTION_CHAINED_OPTIMISATION_FLAGS --time-policy --solver cplex &&
python -m slurm_utils.rec_param_mpc_sweeper --wandb-offline \
...
--max-n-jobs 999 --id-job 2_short_horizon_rec_7_from_rec_28_summer_end_mpc_medium_K --mem-per-cpu 2500 --root-dir $ROOT_DIR --job-dir-name short_horizon_rec_7_from_rec_28_summer_end_mpc_jobs --time-limits 0 0 30 0 --multiprice-flags no-multiprice $SMALL_PEN_CTRL_ACTIONS $SOLUTION_CHAINED_OPTIMISATION_FLAGS --time-policy --solver cplex &&
python -m slurm_utils.rec_param_mpc_sweeper --wandb-offline \
...
--max-n-jobs 999 --id-job 3_short_horizon_rec_7_from_rec_28_summer_end_mpc_high_K --mem-per-cpu 2500 --root-dir $ROOT_DIR --job-dir-name short_horizon_rec_7_from_rec_28_summer_end_mpc_jobs --time-limits 0 1 15 0 --multiprice-flags no-multiprice $SMALL_PEN_CTRL_ACTIONS $SOLUTION_CHAINED_OPTIMISATION_FLAGS --time-policy --solver cplex &&
python -m slurm_utils.rec_param_mpc_sweeper --wandb-offline \
...
--max-n-jobs 999 --id-job 4_short_horizon_rec_7_from_rec_28_summer_end_mpc_high_K --mem-per-cpu 2500 --root-dir $ROOT_DIR --job-dir-name short_horizon_rec_7_from_rec_28_summer_end_mpc_jobs --time-limits 0 1 30 0 --multiprice-flags no-multiprice $SMALL_PEN_CTRL_ACTIONS $SOLUTION_CHAINED_OPTIMISATION_FLAGS --time-policy --solver cplex