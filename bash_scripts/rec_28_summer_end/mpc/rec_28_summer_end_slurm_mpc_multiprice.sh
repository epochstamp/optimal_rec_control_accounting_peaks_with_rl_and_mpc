...
--max-n-jobs 999 --id-job rec_28_summer_end_mpc --job-dir-name rec_28_summer_end_mpc_jobs --time-limits 0 0 45 0 --multiprice-flags multiprice --small-pen-ctrl-actions 1e-5