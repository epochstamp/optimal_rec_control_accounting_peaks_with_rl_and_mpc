...
MODEL_CONFIGS="--model-config rec_6_from_rec_28_data_relu --model-config rec_6_default --model-config rec_6_transformer_default"
python -m slurm_utils.rec_param_rl_sweeper \
--wandb-project rl_study_rec_6_from_rec_28_data --env rec_6 --Delta-M 96 --Delta-P 30 --Delta-P-prime 0 --n-cpus 4 $RL_ENVS --rl-env-eval rl \
...
--max-n-jobs 999 --id-job rec_6_from_rec_28_data_rl --job-dir-name rec_6_rl_jobs --time-limits 0 4 0 --multiprice-flags no-multiprice