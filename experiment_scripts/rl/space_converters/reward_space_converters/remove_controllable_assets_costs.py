...
class RemoveControllableAssetsCosts(RemoveCost):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            key_cost_to_remove="controllable_assets_costs",
            when_to_keep_costs=metering_period_trigger_global_bill_functions["everytime_trigger"]
        )