...
from experiment_scripts.rl.space_converters.observation_space_converters.add_remaining_peak_periods import AddRemainingPeakPeriods
...
class AddRemainingPeakPeriodsRatio(AddRemainingPeakPeriods):
